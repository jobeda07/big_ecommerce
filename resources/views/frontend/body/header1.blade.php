                    ...
                    <div class="header-info">
                        <ul>
                            <li class="contact_header"><i class="fa fa-envelope ms-1"></i>
                                <span>Email &nbsp;:&nbsp; <strong> <a
                                            href="tel:{{ get_setting('email')->value ?? 'null' }}">
                                            {{ get_setting('email')->value ?? 'null' }}</a></strong></span>
                            </li>
