    ...
    <div class="container mb-80 mt-50">
        <div class="row">
            <div class="col-lg-8 mb-40">
                <h1 class="heading-2 mb-10 fs-1">Your Cart</h1>

                <div class="d-flex justify-content-between flex-wrap gap-2">
                    <h6 class="text-body">There are <span class="text-brand" id="total_cart_qty"></span> products in
                        your cart</h6>
                    <h6 class="text-danger"><a href="{{ route('cart.remove.all') }}" id="delete" class="text-danger"><i
        ...
        <div class="row">
            <div class="col-lg-8">
                    ...
                    <table class="table table-wishlist">
                        <thead>
                            <tr class="main-heading">
                                <th width="10px" class="text-center">Image</th>
                                <th width="10px" class="text-center">Product</th>
                                <th width="10px" class="text-center">Price</th>
                                <th width="10px" class="text-center">Quantity</th>
                                <th width="10px" class="text-center">Subtotal</th>
                                <th width="10px" class="end">Remove</th>
                            </tr>
                        </thead>
                ...
                <div class="cart-action d-flex justify-content-between">
                    <a href="{{ route('home') }}" class="btn"><i class="fi-rs-arrow-left mr-10"></i>Continue
                        Shopping</a>
