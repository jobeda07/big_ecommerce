			        	...
			        	<div class="card-body">
			        		<div class="row">
		                        ...
		                        <div class="col-md-6 mb-4">
                                 ...
                                 <div class="col-md-6 mb-4">
                                        <label for="amount_range" class="col-form-label" style="font-weight: bold;">Add Amount Range:</label>
                                      <input class="form-control" id="amount_range" type="number" value="{{ $coupon->amount_range }}" name="amount_range" placeholder="Enter amount range"  min="0">
                                      @error('amount_range')
                                          <p class="text-danger">{{$message}}</p>
                                      @enderror
                                  </div>
