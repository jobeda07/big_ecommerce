...
@section('admin')
    ...
    <section class="content-main">
        <div class="content-header">
            ...
            <div class="">
                <a href="{{ route('customer.index') }}" class="btn btn-primary"><i class="fa-solid fa-arrow-left"></i> Customer
                    List</a>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <input class="form-control" id="name" type="text" name="name"
                                        placeholder="Write Customer Name" value="{{ old('name') }}">
                                    @error('name')
                                ...
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <input class="form-control" id="username" type="text" name="username"
                                        placeholder="Write Customer User Name" value="{{ old('username') }}">
                                    @error('username')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <input class="form-control" id="phone" type="number" name="phone"
                                        placeholder="Write Customer Phone" value="{{ old('phone') }}">
                                    @error('phone')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <input class="form-control" id="email" type="email" name="email"
                                        placeholder="Write Customer Email" value="{{ old('email') }}">
                                    @error('email')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <input class="form-control" type="text" name="address"
                                        placeholder="Write Customer Address" value="{{ old('address') }}">
                                </div>
                                <div class="mb-2 col-sm-12">
                                    <img id="showImage" class="rounded avatar-lg mb-3"
                                ...
                                <div class="col-sm-12 mb-4">
                                    <label for="image" class="col-form-label" style="font-weight: bold;">Customer
                                        Photo:</label>
