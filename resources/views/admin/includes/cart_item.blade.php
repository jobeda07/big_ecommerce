        ...
        <td style="width: 20%;" >
            ...
            <div class="input-group quantity__btn__change">
                ...
                <button class="input-group-text rounded-0 bg-navy add_btn incress_quantity changeQuantity quantityChange"
                 ...
                 <button class="gift_status" style="padding:5px;border:none"><i class="fa-solid fa-gift"></i></button>
                 @else
                 <button class="gift_status" style="color:green;padding:5px;border:none"><i class="fa-solid fa-gift"></i></button>
                 @endif    
            </div>
            <!-- select type -->
