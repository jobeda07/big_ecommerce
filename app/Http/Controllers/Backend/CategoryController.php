...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasfile('banner_image')) {
            ...
            Image::make($banner_image)->resize(1264, 300)->save('upload/category/banner/' . $banner_image_name);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasfile('banner_image')) {
            $banner_image = $request->file('banner_image');
            $banner_image_name = hexdec(uniqid()) . '.' . $banner_image->getClientOriginalExtension();
            Image::make($banner_image)->resize(1264, 322)->save('upload/category/banner/' . $banner_image_name);
            $banner_image = 'upload/category/banner/' . $banner_image_name;
        } else {
            $banner_image = '';
        }
