...
class OrderPaymentController extends Controller
{
    ...
    public function advanced_ledger(Request $request){
        ...
        $advance = $advanceQuery->orderBy('created_at', 'desc')->paginate(100)->appends(request()->query());
        return view('backend.sales.payment.advance_ledger', compact('advance','date','agent_number'));
    }
